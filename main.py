...
# Spotlite Module Router registered under prefix /api/v1/spotlite (Tier 1 & Augmented AI)
app.include_router(spotlite_router, prefix="/api/v1/spotlite", tags=["Spotlite"])
